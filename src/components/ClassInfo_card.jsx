    ...
    render() {
        ...
        return (
            <Collapse bordered defaultActiveKey={a} className="classInfo_card">
                <Collapse.Panel header={<Header data={this.props.data} collapsed={collapsed}/>} className="classInfo_card_header">
...
function Header(props){
    ...
    return(
        <React.Fragment>
            ...
            <div className="classInfo_header_img" style={{backgroundImage:`url(${Server.img_png("view_course_card")})`}}/>
            ...
            <div className="classInfo_header_sec1">
                ...
                <div hidden={!props.collapsed} className="classInfo_header_more">{"اطلاعات بیشتر"}</div>
